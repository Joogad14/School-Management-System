...
export default function ParentSidebar() {
  ...
  { name: "Ward(s)", path: "/parent/wards" },
  { name: "Results", path: "/parent/results" },
   { name: "Profile", path: "/parent/profile" },
  { name: "Pay Tution", path: "/parent/pay-tuition" },
  { name: "Upload Reciept", path: "/parent/upload-tuition" },
];
  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center justify-between bg-[#08142b] text-white px-4 py-3 shadow-md">
        <h2 className="font-bold">Parent Portal</h2>
